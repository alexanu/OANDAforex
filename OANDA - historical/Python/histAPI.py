...
class getHistoricaldata (object):
    ...
    def connect_to_server(self):
        try:
            ...
            print(" --> Connection response code:", resp.status_code,"\n\n")
            print(" --> Message:", resp.headers)
            #view - test
#            print("URL: ", url)
...
#            print("PARAMS: ", params)
    ...
    def get_data(self):
            ...
            print("[+] DATA FOR --> Instrument:", instrument,
                  "  Sampling:", sampling,"\n")
...
# EDIT - should be helper function for getData
